...
const Footer = () => {
    ...
    return (
        <>
            <div className="relative bottom-0 w-[100%] flex p-8 py-4 justify-start items-center bg-black text-white ">
                <div className="flex-1 ml-[15vh] text-4xl font-bold justify-center items-center">PaulKart</div>
                <div className="flex-1 text-4xl font-bold">
                    <ui className='flex flex-col list-none justify-end'>
